...
lv_obj_t * create_meter(lv_obj_t * parent, int min, int max)
{
  ...
  /* FOREGROUND INDICATOR ARC black */
  lv_obj_t * arc_fg = lv_arc_create(cont);
  lv_obj_set_size(arc_fg, 180, 180);
  ...
  lv_obj_set_style_arc_width(arc_fg, 6, LV_PART_INDICATOR);
...
void setupDial(){
  ...
  lv_obj_set_style_pad_row(meter_column, 20, 0); //20px between dials
