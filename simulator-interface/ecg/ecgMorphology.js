...
// Rational Bézier polynomial - matches Python b_polynomial exactly in math
...
export function getECGWave(signalType) {
  ...
  // Match Python concatenation order
  const appendSeg = (X, Y, seg) => {
...
if (signalType === "Normal") {
  ...
  appendSeg(x, y, b_polynomial(t, points_P));
  appendSeg(x, y, b_polynomial(t, points_preQRS));
  appendSeg(x, y, b_polynomial(t, points_QRS));
  appendSeg(x, y, b_polynomial(t, points_preT));
  appendSeg(x, y, b_polynomial(t, points_T));
}
  ...
  appendSeg(x, y, b_polynomial(t, points_P));
  appendSeg(x, y, b_polynomial(t, points_prePacemaker));
  appendSeg(x, y, b_polynomial(t, points_Pacemaker));
  appendSeg(x, y, b_polynomial(t, points_QRS));
  appendSeg(x, y, b_polynomial(t, points_T));
}
    ...
    const seg = b_polynomial(t, points_P);
    appendSeg(x, y, seg);
    ...
    appendSeg(x, y, b_polynomial(t, points_R_first));
    appendSeg(x, y, b_polynomial(t, points_R_second));
    appendSeg(x, y, b_polynomial(t, points_R_third));
