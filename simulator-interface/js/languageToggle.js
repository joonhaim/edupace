...
const TRANSLATIONS = {
    en: {
        ...
        'connection.choose': 'Connect EduPace',
        'connection.subtitle': 'Plug in the console and select its USB port.',
        'connection.empty': 'No devices yet. Connect the console and scan.',
        'connection.refresh': 'Refresh list',
        'connection.scan': 'Scan & grant access',
        'connection.support': 'Works in Chrome, Edge, or the EduPace desktop app.',
    ...
    nl: {
        ...
        'connection.choose': 'Verbind EduPace',
        'connection.subtitle': 'Sluit de console aan en kies de USB-poort.',
        'connection.empty': 'Nog geen apparaten. Sluit de console aan en scan.',
        'connection.refresh': 'Lijst vernieuwen',
        'connection.scan': 'Scannen en toegang verlenen',
        'connection.support': 'Werkt in Chrome, Edge of de EduPace-desktopapp.',
        'home.title': 'Dashboard',
