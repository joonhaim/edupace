...
const TRANSLATIONS = {
    en: {
        ...
        'logs.graph.title': 'Session activity',
        'logs.graph.hint': 'Last 7 days of recorded sessions.',
        'logs.graph.range': 'Last 7 days',
        'logs.graph.total': '{count} sessions',
        'logs.graph.empty': 'No sessions yet to chart.',
        'logs.graph.aria': 'Bar chart of session activity over the last 7 days.',
        'logs.graph.tooltip': '{date}: {count} sessions',
        ...
        'instructions.steps.scenario.body': 'Pick a training case from the scenario dropdown (Normal Sinus Rhythm or Third-degree AV block) and read the summary banner.',
        ...
        'settings.section.sessionInsights': 'Session insights',
    ...
    nl: {
        ...
        'logs.graph.title': 'Sessieactiviteit',
        'logs.graph.hint': 'Laatste 7 dagen met opgenomen sessies.',
        'logs.graph.range': 'Laatste 7 dagen',
        'logs.graph.total': '{count} sessies',
        'logs.graph.empty': 'Nog geen sessies om te tonen.',
        'logs.graph.aria': 'Staafdiagram van sessieactiviteit over de laatste 7 dagen.',
        'logs.graph.tooltip': '{date}: {count} sessies',
        ...
        'settings.section.sessionInsights': 'Sessie-inzichten',
