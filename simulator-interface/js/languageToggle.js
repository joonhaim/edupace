...
const TRANSLATIONS = {
    en: {
        ...
        'instructions.steps.input.body': 'Choose Hardware to use the EduPace device, or Virtual to practice with the on-screen controls.',
    ...
    nl: {
        ...
        'instructions.steps.input.body': 'Kies Hardware om het EduPace-apparaat te gebruiken of Virtueel om met de bediening op het scherm te oefenen.',
        'instructions.steps.scenario.step': 'Scenario',
