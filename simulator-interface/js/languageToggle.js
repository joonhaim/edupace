...
const TRANSLATIONS = {
    en: {
        ...
        'settings.section.intrinsicRates': 'Intrinsic heart rate',
        'settings.section.sessionLog': 'Session log',
        'settings.intrinsicRates.title': 'Intrinsic heart rate by scenario',
        'settings.intrinsicRates.hint': 'Set baseline intrinsic bpm for each scenario.',
        'settings.intrinsicRates.nsr': 'Normal sinus rhythm',
        'settings.intrinsicRates.av3': '3rd degree AV block',
        'settings.intrinsicRates.mobitz2': 'Mobitz II',
        'settings.intrinsicRates.slowConduction': 'Slow conduction',
    ...
    nl: {
        ...
        'settings.section.intrinsicRates': 'Intrinsieke hartslag',
        'settings.section.sessionLog': 'Sessielog',
        'settings.intrinsicRates.title': 'Intrinsieke hartslag per scenario',
        'settings.intrinsicRates.hint': 'Stel de intrinsieke bpm in per scenario.',
        'settings.intrinsicRates.nsr': 'Normaal sinusritme',
        'settings.intrinsicRates.av3': '3e graads AV-blok',
        'settings.intrinsicRates.mobitz2': 'Mobitz II',
        'settings.intrinsicRates.slowConduction': 'Trage geleiding',
