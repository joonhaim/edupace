...
const TRANSLATIONS = {
    en: {
        ...
        'settings.section.beats': 'Beats & Alarms',
        'settings.section.volume': 'Volume',
        'settings.section.device': 'Device behaviour',
        'settings.section.realism': 'Physiology realism',
        'settings.section.training': 'Training',
        'settings.section.sessionLog': 'Session log',
        'settings.sweepSpeed.title': 'Sweep speed',
        'settings.sweepSpeed.hint': 'Millimeters per second.',
        'settings.sweepSpeed.aria': 'Sweep speed',
        'settings.sweepWindow.title': 'Sweep window',
        'settings.sweepWindow.hint': 'Visible seconds on screen.',
        'settings.sweepWindow.aria': 'Sweep window',
        'settings.amplitude.title': 'Amplitude',
        'settings.amplitude.hint': 'Millimeters per mV.',
        'settings.amplitude.aria': 'Amplitude scaling',
        ...
        'settings.qrsBeep.title': 'ECG QRS beep',
        'settings.qrsBeep.hint': 'Classic, soft, or off.',
        'settings.qrsBeep.aria': 'QRS beep',
        'settings.qrsBeep.classic': 'Classic',
        'settings.qrsBeep.soft': 'Soft',
        'settings.alarmSounds.title': 'Alarm sounds',
        'settings.alarmSounds.hint': 'Enable audible alarms.',
        'settings.buttonBeeps.title': 'Button beeps',
        'settings.buttonBeeps.hint': 'Feedback tones when controls are used.',
        'settings.section.volume': 'Volume',
        'settings.notificationVolume.title': 'Notification volume',
        'settings.notificationVolume.hint': 'Overall alert volume.',
        'settings.section.device': 'Device behaviour',
        ...
        'settings.section.realism': 'Physiology realism',
        'settings.captureDrift.title': 'Capture threshold drift',
        'settings.captureDrift.hint': 'Off, mild, or strong drift.',
        'settings.captureDrift.aria': 'Capture threshold drift',
        'settings.captureDrift.mild': 'Mild',
        'settings.captureDrift.strong': 'Strong',
        'settings.section.training': 'Training',
        'settings.postReview.title': 'Post-scenario review',
        'settings.postReview.hint': 'Auto-open, ask, or off.',
        'settings.postReview.aria': 'Post-scenario review',
        'settings.postReview.auto': 'Auto-open',
        'settings.postReview.ask': 'Ask',
        'settings.section.sessionLog': 'Session log',
    ...
    nl: {
        ...
        'settings.section.beats': 'Slagen en alarmen',
        'settings.section.volume': 'Volume',
        'settings.section.device': 'Apparaatgedrag',
        'settings.section.realism': 'Fysiologische realiteit',
        'settings.section.training': 'Training',
        'settings.section.sessionLog': 'Sessielog',
        'settings.sweepSpeed.title': 'Loopsnelheid',
        'settings.sweepSpeed.hint': 'Millimeter per seconde.',
        'settings.sweepSpeed.aria': 'Loopsnelheid',
        'settings.sweepWindow.title': 'Sweepvenster',
        'settings.sweepWindow.hint': 'Zichtbare seconden op scherm.',
        'settings.sweepWindow.aria': 'Sweepvenster',
        'settings.amplitude.title': 'Amplitude',
        'settings.amplitude.hint': 'Millimeter per mV.',
        'settings.amplitude.aria': 'Amplitude-instelling',
        ...
        'settings.qrsBeep.title': 'ECG QRS-beep',
        'settings.qrsBeep.hint': 'Klassiek, zacht of uit.',
        'settings.qrsBeep.aria': 'QRS-beep',
        'settings.qrsBeep.classic': 'Klassiek',
        'settings.qrsBeep.soft': 'Zacht',
        'settings.alarmSounds.title': 'Alarmsgeluiden',
        'settings.alarmSounds.hint': 'Zet hoorbare alarmen aan.',
        'settings.buttonBeeps.title': 'Knopgeluiden',
        'settings.buttonBeeps.hint': 'Feedbacktonen bij bediening.',
        'settings.notificationVolume.title': 'Meldingsvolume',
        'settings.notificationVolume.hint': 'Algemeen alarmvolume.',
        ...
        'settings.captureDrift.title': 'Capturedrempel-drift',
        'settings.captureDrift.hint': 'Uit, mild of sterk drift.',
        'settings.captureDrift.aria': 'Capturedrempel-drift',
        'settings.captureDrift.mild': 'Mild',
        'settings.captureDrift.strong': 'Sterk',
        'settings.postReview.title': 'Nabespreking na scenario',
        'settings.postReview.hint': 'Automatisch openen, vragen of uit.',
        'settings.postReview.aria': 'Nabespreking',
        'settings.postReview.auto': 'Automatisch openen',
        'settings.postReview.ask': 'Vragen',
