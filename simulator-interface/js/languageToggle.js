...
const TRANSLATIONS = {
    en: {
        ...
        'connection.showAll': 'Show all serial devices',
        ...
        'instructions.steps.connect.body': 'Launch the EduPace desktop app and plug the EduPace device into the right-most USB-C port (screen and knobs facing up). Press "CONNECT" on the Training page. In a browser, use Chrome, Edge, or another WebSerial-compatible browser.',
        'instructions.steps.input.step': 'Mode',
        'instructions.steps.input.title': 'Choose input mode',
        'instructions.steps.input.body': 'Choose Hardware to use the EduPace device, or Virtual to practice with keyboard/mouse.',
        'instructions.steps.scenario.step': 'Scenario',
        'instructions.steps.scenario.title': 'Select a scenario',
        'instructions.steps.scenario.body': 'Select a training case from the scenario list and read the summary.',
        'instructions.steps.parameters.step': 'Tune',
        'instructions.steps.parameters.title': 'Adjust pacing parameters',
        'instructions.steps.parameters.body': 'Set Rate, Output, and Sensitivity using the knobs or sliders. Watch the ECG, LEDs, and HR tile.',
        'instructions.steps.review.step': 'Review',
        'instructions.steps.review.title': 'End and save',
        'instructions.steps.review.body': 'End the session, enter your name, add notes, and save the log.',
        'instructions.steps.settings.step': 'Customize',
        'instructions.steps.settings.title': 'Settings and stats',
        'instructions.steps.settings.body': 'Use Settings for language, Bright/Dark mode, ECG, and sound. Review Session Log and Leaderboards to track progress.',
    ...
    nl: {
        ...
        'connection.showAll': 'Toon alle seriële apparaten',
        ...
        'instructions.steps.connect.body': 'Start de EduPace-desktopapp en sluit het EduPace-apparaat aan via de meest rechtse USB-C-poort (scherm en knoppen omhoog). Druk op "CONNECT" op de Trainingspagina. Gebruik in een browser Chrome, Edge of een andere WebSerial-compatibele browser.',
        'instructions.steps.input.step': 'Modus',
        'instructions.steps.input.title': 'Kies invoermodus',
        'instructions.steps.input.body': 'Kies Hardware om het EduPace-apparaat te gebruiken of Virtueel om met toetsenbord/muis te oefenen.',
        'instructions.steps.scenario.step': 'Scenario',
        'instructions.steps.scenario.title': 'Selecteer een scenario',
        'instructions.steps.scenario.body': 'Selecteer een training uit de scenariolijst en lees de samenvatting.',
        'instructions.steps.parameters.step': 'Afstemmen',
        'instructions.steps.parameters.title': 'Pas pacingparameters aan',
        'instructions.steps.parameters.body': 'Stel Rate, Output en Sensitivity in met de knoppen of schuifregelaars. Let op ECG, leds en het HR-vak.',
        'instructions.steps.review.step': 'Review',
        'instructions.steps.review.title': 'Beëindig en sla op',
        'instructions.steps.review.body': 'Beëindig de sessie, vul je naam in, voeg notities toe en sla de log op.',
